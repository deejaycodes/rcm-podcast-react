      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 max-w-lg mx-auto w-full">
        ...
        <div className="flex items-center justify-center gap-8 relative">
          <div className="relative">
            <button onClick={() => setShowRate(!showRate)} className="text-xs font-bold text-gray-400 hover:text-gray-700 transition px-2 py-1 rounded-lg hover:bg-gray-50">{player.playbackRate}x</button>
            {showRate && (
